...
glm::vec3 cubePositions[] = {
  ...
  glm::vec3( 2.0f,  5.0f, -13.5f), 
  glm::vec3(-1.5f, -2.2f, -1.0f),  
  glm::vec3(-3.8f, -2.0f, -11.0f),  
  glm::vec3( 2.4f, -0.4f, -2.0f),  
  glm::vec3(-1.7f,  3.0f, -6.0f),  
...
void render()
{
    ...
    glm::mat4 view;
    view = glm::translate( view, glm::vec3(0.5f, -1.0f, -3.0f) );
    glm::mat4 projection;
    ...
    // the first cube
    glm::mat4 AnotherModel;
    AnotherModel = glm::translate( AnotherModel, cubePositions[0] );
    GLfloat angle = glm::radians(glfwGetTime() * 30.0f);
    AnotherModel = glm::rotate( AnotherModel, angle, glm::vec3(1.0f, 0.3f, 0.5f) );
    glUniformMatrix4fv( UniformModelLocation, 1, GL_FALSE, glm::value_ptr(AnotherModel) );
	...
	GLfloat RestAngle = 20.0f * i;
	model = glm::rotate( model, RestAngle, glm::vec3(1.0f, 0.3f, 0.5f) );
	glUniformMatrix4fv( UniformModelLocation, 1, GL_FALSE, glm::value_ptr(model) );
	glDrawArrays( GL_TRIANGLES, 0, 36 );
    }
