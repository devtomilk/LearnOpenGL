...
void initScene()
{
    cubeShader = new Shader( "basic.vert", "directional.frag" );
    ...
    glUniform3f( glGetUniformLocation(cubeShader->program, "light.direction"), -0.2f, -1.0f, -1.0f );
