...
const std::string vertSourceString = read_file( "ex03.vert" );
const std::string fragSourceString = read_file( "ex03.frag" );
const std::string frag2SourceString = read_file( "ex03_02.frag" );
const GLchar* vertexShaderSource = vertSourceString.c_str();
const GLchar* fragmentShaderSource = fragSourceString.c_str();
const GLchar* fragmentShader2Source = frag2SourceString.c_str();
